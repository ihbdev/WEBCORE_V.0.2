	...
	<div class="folder top">
		...
		<div class="folder-header">
			...
			<div class="header-menu">
				<ul>
					<li class="ex-show"><a class="activities-icon" href=""><span>Danh sách tuyển dụng</span></a></li>
				</ul>
			</div>
		</div>
		<!--end title-->
		<div class="folder-content">
            <div>
            	<input type="button" class="button" value="Thêm mới" style="width:180px;" onClick="parent.location='<?php echo Yii::app()->createUrl('admin/recruitment/create')?>'"/>
			...
			$this->widget('iPhoenixGridView', array(
  				...
  				'columns'=>array(
					array(
						...
						'checked'=>'in_array($data->id,Yii::app()->session["checked-recruitment-list"])'
    				),			
    				array(
						'name'=>'title',
					...
					array(
    					...
    					(
    						...
    						(
            					...
            					'url'=>'Yii::app()->createUrl("admin/recruitment/reverseStatus", array("id"=>$data->id))',
    							'click'=>'function(){
									var th=this;									
									jQuery.ajax({
										type:"POST",
					...
					array(
    					...
    					(
    						...
    						(
            					...
            					'url'=>'Yii::app()->createUrl("admin/recruitment/copy", array("id"=>$data->id))',
        					),
        					'view'=>array(
    							'url'=>'$data->url',
    						)
				...
				'actions'=>array(
					...
					'delete'=>array(
						...
						'url'=>'admin/recruitment/checkbox'
					),
					*/
					'copy'=>array(
						'action'=>'copy',
