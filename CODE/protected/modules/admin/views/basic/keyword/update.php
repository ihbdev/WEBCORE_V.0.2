	...
	<div class="folder top">
		...
		<div class="folder-header">
			...
			<div class="header-menu">
				<ul>
					<li><a class="header-menu-active new-icon" href=""><span>Chỉnh sửa từ khóa</span></a></li>					
				</ul>
			</div>
		</div>
		<!--end title-->	
		<div class="folder-content form">
			<div>
                <input type="button" class="button" value="Danh sách từ khóa" style="width:180px;" onClick="parent.location='<?php echo Yii::app()->createUrl('admin/keyword')?>'"/>
               	<input type="button" class="button" value="Thêm từ khóa" style="width:180px;" onClick="parent.location='<?php echo Yii::app()->createUrl('admin/keyword/create')?>'"/>
