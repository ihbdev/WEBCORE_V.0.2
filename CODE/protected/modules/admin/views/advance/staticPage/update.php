<!--begin inside content-->
	<div class="folder top">
		...
		<div class="folder-header">
			<h1>Quản trị các trang tĩnh</h1>
			<div class="header-menu">
				<ul>
					<li><a class="header-menu-active new-icon" href=""><span>Chỉnh sửa trang<?php echo $model->title;?></span></a></li>					
				</ul>
			</div>
		</div>
		<!--end title-->
		...
		<div>
            	<input type="button" class="button" value="Thêm trang tĩnh" style="width:180px;" onClick="parent.location='<?php echo Yii::app()->createUrl('admin/staticPage/create')?>'"/>
                <input type="button" class="button" value="Danh sách trang tĩnh" style="width:180px;" onClick="parent.location='<?php echo Yii::app()->createUrl('admin/staticPage')?>'"/>
