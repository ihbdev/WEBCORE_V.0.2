	...
	<div id="TP_container">
		<div id="TP_inner">
			...
			<div id="TP_right_panel" class="TP_toolbar_item">
				<p><a href="<?php echo Yii::app()->createUrl('admin/default/view',array('view'=>'basic'));?>">Giao diện cơ bản</a> | <a href="<?php echo Yii::app()->request->getBaseUrl(true);?>">Trang chủ</a> | <a href="<?php echo Yii::app()->createUrl('/admin/default/logout');?>">Đăng xuất</a> (<span style="color:#d9251d;"><?php echo Yii::app()->user->name;?></span>)</p>
