	...
	<div class="folder top">
		...
		<div class="folder-header">
			...
			<div class="header-menu">
				<ul>
					<li><a class="header-menu-active new-icon" href=""><span>Danh sách tư vấn viên</span></a></li>					
				</ul>
			</div>
		</div>
		<!--end title-->	
		<div class="folder-content form">
			<div>
                <input type="button" class="button" value="Danh sách tư vấn viên" style="width:180px;" onClick="parent.location='<?php echo Yii::app()->createUrl('admin/support')?>'"/>
