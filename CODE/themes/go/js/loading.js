...
LoadBar.prototype.locate = function(){
	...
	//loadingZone.style.top = parseInt(windowHeight/2-popupHeight/2) + "px"; -- do chieu cao
	loadingZone.style.top = "320px";
...
LoadBar.prototype.loaded = function(file) {
	...
	this.setValue(pc);
	// this.setAction(file + " loaded"); --Hien thi ten file
	this.setAction("loading...");
