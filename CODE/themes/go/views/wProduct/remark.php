<div class="box-title"><label><?php echo Language::t ( 'Sản phẩm nổi bật','layout' );?></label></div>
                <div class="box-content">
                	...
                	<?php foreach ($list_product as $product):?>
                        <div class="grid">
                            ...
                            <div class="g-content">
                                <div class="g-row"><a class="g-title" href="<?php echo $product->url?>"><?php echo $product->name?></a></div>
