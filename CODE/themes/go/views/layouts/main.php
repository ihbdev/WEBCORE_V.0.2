...
<div class="wrapper">
    ...
    <div class="bground">
        <div class="sidebar-left">
       		<div class="winget">
       			<?php $this->widget('wCategory',array('type'=>$this->type_menu_left,'view'=>'menu-left','current_catid'=>$this->current_catid));?>               
            </div><!--winget-->
            <div class="winget">
            	<?php $this->widget('wSupport',array('view'=>'support','limit'=>Setting::s('SIZE_SUPPORT','Support')));?>                     
            </div><!--winget-->
            <div class="winget">
                <div class="winget-title"><label>Chứng chỉ</label></div>
                <div class="winget-content">
					<img class="img" src="<?php echo Yii::app()->theme->baseUrl?>/images/certification.jpg" alt="certification">
                </div><!--winget-content-->
            </div><!--winget-->
        </div><!--sidebar-left-->
        <div class="main">
