...
<div class="contact-outer">
                ...
                <div class="contact-map">
                	<div class="tab-content1">
                    	<?php echo Language::t('Bản đồ 1')?>
                    </div>
                    <div class="tab-content2">
                    	<?php echo Language::t('Bản đồ 2')?>
                    </div>
                </div><!--contact-map-->
                <?php $form=$this->beginWidget('CActiveForm', array('method'=>'post','enableAjaxValidation'=>false,'htmlOptions'=>array('class'=>'contact-form form','style'=>'display:block'))); ?>
                    ...
                    <div class="row fix-inline">
                        <h3><?php echo Language::t('(*) Phần thông tin bắt buộc')?>:</h3>
                    </div>
                    <div class="row fix-inline">
                    ...
                    <div class="row">
                        <input type="submit" value="<?php echo Language::t('Gửi đi')?>" class="button" name="btn-submit" />
                    </div>
                <?php $this->endWidget(); ?>
            </div><!--contact-outer-->
