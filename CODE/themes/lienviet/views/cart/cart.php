...
<div class="cart-outer">
                ...
                <div class="cart-button" style="margin:-20px 0 10px 480px;">
                    <a href="<?php echo Yii::app()->createUrl('product/index');?>" class="button"><?php echo Language::t('Mua hàng tiếp')?></a>
                </div><!--cart-button-->
                <div class="cart-note">
               ...
               <?php $form=$this->beginWidget('CActiveForm', array('action'=>Yii::app()->createUrl('cart/cart'),'method'=>'post','enableAjaxValidation'=>false,'htmlOptions'=>array('class'=>'contact-form form','style'=>'display:block'))); ?>
                    ...
                    <div class="row">
                        <input type="submit" value="Đặt hàng" class="button" name="btn-submit" />
                    </div>
                <?php $this->endWidget(); ?>
            </div><!--cart-outer-->